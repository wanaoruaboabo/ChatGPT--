    ...
    \begin{tikzpicture}
        \begin{axis}
            [
                ...
                \addplot[very thick,brown,no marks, smooth, domain=60:100, samples=50] {-40/(1+exp(-(x-66)/3))+101};
    ...
    \begin{tikzpicture}
        \begin{axis}
            [
                ...
                \addplot[very thick,brown,no marks, smooth, domain=60:100, samples=50] {40/(1+exp(-(x-66)/3))+59};
