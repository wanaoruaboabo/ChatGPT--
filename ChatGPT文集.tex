    ...
    \begin{tikzpicture}
        \begin{axis}
            [
                ...
                \addplot[very thick,brown,no marks, smooth, domain=0:6, samples=50] {-40/(1+exp(-(x-1)))+100};
    ...
    \begin{tikzpicture}
        \begin{axis}
            [
                ...
                \addplot[very thick,brown,no marks, smooth, domain=0:6, samples=50] {40/(1+exp(-(x-1)))+60};
...
\begin{multicols}{2}
    ...
    \begin{enumerate}
        ...
        \item 可以提高消化功能：吃屎可以提高消化功能，因为它含有大量的维生素和营养物质，可以帮助消化系统正常运作。
        \item 可以改善免疫力：吃屎可以改善免疫力，因为它含有大量的维生素和营养物质，可以帮助提高免疫力。
        \item 可以改善肠道健康：吃屎可以改善肠道健康，因为它含有大量的维生素和营养物质，可以帮助肠道健康。
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item 可能会引起腹泻：吃屎可能会引起腹泻，因为它含有大量的细菌，可能会导致腹泻。
        \item 可能会引起营养不良：吃屎可能会引起营养不良，因为它含有大量的细菌，可能会导致营养不良。
        \item 可能会引起疾病：吃屎可能会引起疾病，因为它含有大量的细菌，可能会导致疾病。
    \end{enumerate}

\end{multicols}

老胡认为，吃屎有一定的优点。首先，它可以帮助人们消化食物，从而获得更多的营养。其次，它可以帮助人们排出体内的毒素，从而保持身体健康。此外，它还可以帮助人们改善免疫力，从而预防疾病。
但是，老胡也认为吃屎也有一些缺点。首先，它可能会引起腹泻，从而导致营养不良。其次，它可能会引起腹痛，从而影响人们的正常生活。此外，它还可能会引起腹胀，从而影响人们的食欲。

综上所述，老胡认为，屎既有优点也有缺点，既能延长寿命也能缩短寿命。

\chapter{新型牙膏}
\begin{enumerate}
    \item 价格实惠：屎当牙膏的价格比普通牙膏要便宜得多，可以节省家庭开支。
    \item 清洁力强：屎当牙膏含有抗菌成分，可以有效清除牙菌斑，抑制口腔细菌的滋生，保持口腔清洁。
    \item 具有抗敏功能：屎当牙膏含有抗敏成分，可以有效抑制牙龈敏感，减轻牙齿痛症。
    \item 具有防蛀功能：屎当牙膏含有防蛀成分，可以有效防止牙齿蛀牙，保护牙齿健康
